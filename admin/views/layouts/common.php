...
foreach (SystemLog::find()->orderBy(['log_time' => SORT_DESC])->limit(5)->all() as $logEntry) {
    $logEntries[] = [
        ...
        'url' => Url::toRoute(['system/log/view', 'id' => $logEntry->id])
    ];
        ...
        <?php echo Nav::widget([
            ...
            'items' => [
                [
                    ...
                    'url'  => Url::to('timeline-event/index')
                ],
                [
                    // log events
                    ...
                    'items' => [
                        ...
                        [
                            ...
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'Articles'),
                                    'url' => Url::to('/content/article/index'),
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'article',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Categories'),
                                    'url' => Url::to('/content/category/index'),
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                        ...
                        [
                            'label' => Yii::t('backend', 'Translation'),
                            'url' => Url::to('/translation/default/index'),
                        ...
                        [
                            ...
                            'items' => [
                                [
                                    ...
                                    'url' => Url::to('/rbac/rbac-auth-assignment/index'),
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                ],
                                [
                                    'label' => Yii::t('backend', 'Items'),
                                    'url' => Url::to('/rbac/rbac-auth-item/index'),
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                ],
                                [
                                    'label' => Yii::t('backend', 'Child Items'),
                                    'url' => Url::to('/rbac/rbac-auth-item-child/index'),
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                ],
                                [
                                    'label' => Yii::t('backend', 'Rules'),
                                    'url' => Url::to('/rbac/rbac-auth-rule/index'),
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                ],
                            ],
                        ],
