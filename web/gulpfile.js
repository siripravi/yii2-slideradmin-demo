...
const paths = {
  build: {
    html: ".web/web/build",
    js: ".web/web/buildjs/",
    css: ".web/web/buildcss/",
    img: ".web/web/buildimg/",
    lib: ".web/web/buildlib/",
    fonts: ".web/web/buildfonts/",
  },
  src: {
...
/*
function del() {
  return gulp.src(".web/web/build*", { read: false }).pipe(clean());
}*/
/* include gulp and plugins */

gulp.task("clean:css:my", function (cb) {
  //cache.clearAll();
  return del(["web/buildcss/custom*.css"], cb);
});
  ...
  gulp.series("clean:css:my", function () {
    return (
      gulp
        ...
        .pipe(gulp.dest(".web/web/buildcss"))
        .pipe(reload({ stream: true }))
    );
  })
);

/web/build partial html files
...
gulp.task("clean:build", function () {
  return del([".web/web/build*"]);
});
gulp.task("clean:templates", function (cb) {
 // return del(["web/build*.html"], cb);
});
