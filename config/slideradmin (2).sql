...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2024 at 10:10 AM
...
(3, 1, 'cookies', 1710243078, 1726338954, 2, 1);
...
--
-- Table structure for table `hin_migration`
--

CREATE TABLE `hin_migration` (
  `version` varchar(180) NOT NULL,
  `apply_time` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `hin_migration`
--

INSERT INTO `hin_migration` (`version`, `apply_time`) VALUES
('m000000_000000_base', 1726654850);
...
--
-- Table structure for table `hin_user_group`
--

CREATE TABLE `hin_user_group` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `nxt_file_storage_item`
--

CREATE TABLE `nxt_file_storage_item` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `nxt_file_storage_item`
--

INSERT INTO `nxt_file_storage_item` (`id`, `component`, `base_url`, `path`, `type`, `size`, `name`, `upload_ip`, `created_at`) VALUES
(2, 'fileStorage', 'http://storage.starterkit.local/storage/web/source', '1\\3NwOpmzVOmiduBeaMk_mYcQslPloxZKn.png', 'image/png', 133294, '3NwOpmzVOmiduBeaMk_mYcQslPloxZKn', '127.0.0.1', 1726559153),
(3, 'fileStorage', 'http://storage.starterkit.local/storage/web/source', '1\\lHvJN8Lag1q24LYwkUuapd-akJ4XDRXA.png', 'image/png', 333944, 'lHvJN8Lag1q24LYwkUuapd-akJ4XDRXA', '127.0.0.1', 1726559230),
(4, 'fileStorage', 'http://storage.starterkit.local/storage/web/source', '1\\RD7tAs8dpcdZ028kbqBXhTHwvOWuT0K_.jpg', 'image/jpeg', 63656, 'RD7tAs8dpcdZ028kbqBXhTHwvOWuT0K_', '127.0.0.1', 1726559285),
(5, 'fileStorage', 'http://storage.starterkit.local/storage/web/source', '1\\0hErqMq9sD1ouwtmJ0Uxgd6UEZUjZcq3.png', 'image/png', 173123, '0hErqMq9sD1ouwtmJ0Uxgd6UEZUjZcq3', '127.0.0.1', 1726569446),
(6, 'fileStorage', 'http://storage.starterkit.local/storage/web/source', '1\\uuZ2BxxoFw804W4AYGd56hAVVm9011dv.png', 'image/png', 191426, 'uuZ2BxxoFw804W4AYGd56hAVVm9011dv', '127.0.0.1', 1726569980),
(7, 'fileStorage', 'http://storage.starterkit.local/storage/web/source', '1\\5m72X46ELFS0wrlmMhLv--UIeYkNFXsE.png', 'image/png', 69672, '5m72X46ELFS0wrlmMhLv--UIeYkNFXsE', '127.0.0.1', 1726569994),
(8, 'fileStorage', 'http://storage.starterkit.local/storage/web/source', '1\\jVb0k5Q6ZlxDEddjT-5tjAZGJXgUVNJ6.png', 'image/png', 64751, 'jVb0k5Q6ZlxDEddjT-5tjAZGJXgUVNJ6', '127.0.0.1', 1726569999),
(9, 'fileStorage', 'http://storage.starterkit.local/storage/web/source', '1\\b7byLX9K22k5uAp8wfkIYJVvr9qTumf6.png', 'image/png', 191426, 'b7byLX9K22k5uAp8wfkIYJVvr9qTumf6', '127.0.0.1', 1726593653);
...
(3, 12, 'Purnachandra Rao', 'Valluri', '', NULL, 0, ''),
...
(19, '', '1e3a5fa11cea887d5b0145010cec8d31.jpg', 'jpg', 'image/jpeg', 202414, 1727420526, 1727420526, 0, 1, 2),
(20, '', 'db87285a23f9dcc427bb1ac726a83a84.png', 'png', 'image/png', 57211, 1727768718, 1727768718, 0, 1, 3),
(21, '', 'e515d8617a00c46cfb848977e2995282.png', 'png', 'image/png', 33831, 1727768743, 1727768743, 0, 1, 3),
(22, '', '3f8b2f2d4300b1c0c46097d10f5d0c3d.png', 'png', 'image/png', 192720, 1727768770, 1727768770, 0, 1, 3);
...
(19, 'en', '', '<p><strong _msthash=\"196\" _msttexthash=\"1060410\">Paralympic Gold Medalist Navdeep Singh</strong></p>\r\n'),
(19, 'hi', 'Responsive Image Three', '<p><strong _msthash=\"188\" _msttexthash=\"1060410\">Paralympic Gold Medalist Navdeep Singh</strong></p>\r\n');
...
(12, 'provdigi@gmail.com', 'provdigi@gmail.com', '$2y$13$dKC10Y3BBjomt5pd3wplLO6MMq9RS1mNx1/dKJuvwo/xZRqzcQPl6', 'ijWRLD1L2LHxVxB7Bh678W697gVKr-Od', 1702494185, NULL, NULL, '::1', 1702476958, 1726338079, 0, NULL, 1702476958),
...
(1, 1, 0, '', 'BUT24542', 280.00, 532.00, 10, 2, 1710242977, 1725475873, 0, 1),
...
(1, 1, 34, 'other', 'sbdba92535c1d9e8d4c4bf739243bb546.jpg', 0, 1708801284),
(2, 2, 34, 'other', 'purnachandra.png', 0, 1708801348),
(3, 3, 34, 'other', '6cddc47754ffef911c50b6921584e411a.jpg', 0, 1710246890),
...
--
-- Indexes for table `hin_migration`
--
ALTER TABLE `hin_migration`
  ADD PRIMARY KEY (`version`);

--
-- Indexes for table `hin_user`
--
ALTER TABLE `hin_user`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `hin_user_group`
--
ALTER TABLE `hin_user_group`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `nxt_file_storage_item`
--
ALTER TABLE `nxt_file_storage_item`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `hin_user`
--
ALTER TABLE `hin_user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `hin_user_group`
--
ALTER TABLE `hin_user_group`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `nxt_file_storage_item`
--
ALTER TABLE `nxt_file_storage_item`
...
--
-- Constraints for table `hin_user`
--
ALTER TABLE `hin_user`
  ADD CONSTRAINT `fk_user_group` FOREIGN KEY (`user_group_id`) REFERENCES `hin_user_group` (`id`) ON DELETE CASCADE;
